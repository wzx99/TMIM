...
class LPU(nn.Module):
    ...
    LPU(X) = DWConv(X) + X
    """
    def __init__(self, in_channels, out_channels, stride = 1, input_resolution=None):
...
class Uformer(nn.Module):
    def __init__(self, img_size=256, in_chans=3, dd_in=3,
                 ...
                 cross_modulator=False, tmim=False, **kwargs):
        super().__init__()
        ...
        if self.tmim:
            self.task_prompt = nn.Embedding(2, embed_dim*16)
...
class UformerTMIM(BaseTMIM):
    def __init__(self, *args, **kwargs):
        super(UformerTMIM, self).__init__()
        self.model = Uformer(*args, **kwargs)


class UformerSTR(BaseSTR):
    def __init__(self, *args, **kwargs):
        super(UformerSTR, self).__init__()
        self.model = Uformer(*args, **kwargs)
