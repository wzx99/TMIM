...
class json2CoCo:
    ...
    def _annotation(self, line):
        points = np.array(line['points']).reshape(-1).tolist()
        ...
        annotation['illegibility'] = illegibility
...
if __name__ == '__main__':
    image_dir = '/data/zixiao_wang/text_det/lsvt/train_images'
    json_dir = '/data/zixiao_wang/text_det/lsvt/train_full_labels.json'
    saved_coco_path = '/data/zixiao_wang/text_det/lsvt/annotation.json'
    
    l2c_train = json2CoCo(image_dir=image_dir, json_dir=json_dir)
