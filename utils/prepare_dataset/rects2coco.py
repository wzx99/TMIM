...
class json2CoCo:
    ...
    def to_coco(self):
        ...
        for image in image_list:
            ...
            with open(os.path.join(self.json_dir, image[:-4]+'.json'), 'r') as f:
                label =  json.load(f)
            reader = label['lines']
            for line in reader:
...
if __name__ == '__main__':
    image_dir = '/data/zixiao_wang/text_det/rects/img'
    json_dir = '/data/zixiao_wang/text_det/rects/gt'
    saved_coco_path = '/data/zixiao_wang/text_det/rects/annotation.json'
