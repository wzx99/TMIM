...
class txt2CoCo:
    ...
    def to_coco(self):
        ...
        for image in image_list:
            ...
            reader = open(os.path.join(self.txt_dir, image[:-4]+'.txt'), 'r', encoding='utf8').readlines()
            for line in reader:
...
if __name__ == '__main__':
    image_dir = '/data/zixiao_wang/text_det/mlt/train_images'
    txt_dir = '/data/zixiao_wang/text_det/mlt/train_gts'
    saved_coco_path = '/data/zixiao_wang/text_det/mlt/annotation.json'
